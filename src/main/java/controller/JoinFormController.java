...
public class JoinFormController implements Command{
	...
	public String execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String pw = (String)req.getParameter("password");		// 비밀번호
		String pwc = (String)req.getParameter("passwordCheck");	// 비밀번호 재확인
...
//		// 아이디 중복 체크		
//		String isId = req.getParameter("checkUserId"); // joinForm.jsp에서 넘어온 checkUserId (ID)
